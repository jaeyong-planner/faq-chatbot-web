        ...
        <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
          <div className="max-w-2xl w-full bg-gray-800 rounded-lg shadow-xl p-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-white">렌더링 오류가 발생했습니다</h2>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">해결 방법:</h3>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
                  <li>아래 버튼을 클릭하여 앱을 다시 시작하세요</li>
                  <li>문제가 계속되면 브라우저 캐시를 삭제해보세요</li>
                  <li>개발자 도구(F12)에서 자세한 오류 내용을 확인할 수 있습니다</li>
                </ul>
              </div>
              ...
              <details className="mt-4">
                <summary className="text-gray-400 cursor-pointer hover:text-gray-300">기술적인 세부 정보 표시</summary>
