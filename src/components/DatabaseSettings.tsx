      ...
      <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-black">현재 데이터베이스 상태</h3>
            <button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-orange-50 rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-orange-600">{stats.totalFAQs}</div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
          <div className="flex items-start">
            ...
            <div className="text-sm">
              <p className="text-blue-800 font-medium mb-1">Supabase 웹 서비스 정보</p>
              <ul className="text-blue-700 space-y-1">
                <li>• 모든 데이터는 Supabase 클라우드에 저장됩니다</li>
                <li>• 데이터 백업은 Supabase에서 자동으로 관리됩니다</li>
                <li>• 환경 변수(.env)에서 Supabase 연결 정보를 설정할 수 있습니다</li>
                <li>• Supabase 대시보드에서 직접 데이터를 관리할 수 있습니다</li>
              </ul>
            </div>
          </div>
        </div>
