...
const PDFDocumentViewer: React.FC<PDFDocumentViewerProps> = ({
  ...
  const tabs = [
    ...
    { id: 'faqs', name: '엠브레인Agent관리', icon: 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' }
  ];
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto">
          ...
          {activeTab === 'faqs' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-black">엠브레인Agent관리</h3>
                <button
